CREATE TABLE `form_ros` (
	...
	`oriented` varchar(3) NOT NULL default 'N/A',
	`Disoriented ` varchar(3) NOT NULL default 'N/A',
	`Normally_Hydrated` varchar(3) NOT NULL default 'N/A',
	`Dehydrated` varchar(3) NOT NULL default 'N/A',
