...
<body id="codes_search">
    <div class="container-fluid">
        <form method='post' name='theform'>
            ...
            echo "\n";
            echo "<button class='btn btn-sm btn-save' value='" . xla('OK') . "' onclick='onOK()' style='background-color: #77bc1f; color: white;'>" . xla('Ok') . "</button>\n";
            echo "\n";
            echo "<button class='btn btn-sm btn-cancel' value='" . xla('Cancel') . "' onclick='dlgclose()' style='background-color: red; color: white;'>" . xla('Cancel') . "</button>\n";
            echo "</div>";
